        ...
        <div class="container">
            <div id="powered" class="clearfix">
                ...
                <div class="social pull-right flip">
                    <a href="#" target="_blank"> <img data-toggle="tooltip" src="<?php echo Asset::image('socialicons/facebook.png');?>" alt="Facebook" title="Facebook"></a>
                    <a href="#" target="_blank"> <img data-toggle="tooltip" src="<?php echo Asset::image('socialicons/twitter.png');?>" alt="Twitter" title="Twitter"> </a>
                    <a href="#" target="_blank"> <img data-toggle="tooltip" src="<?php echo Asset::image('socialicons/google_plus.png');?>" alt="Google+" title="Google+"> </a>
                    <a href="#" target="_blank"> <img data-toggle="tooltip" src="<?php echo Asset::image('socialicons/pinterest.png');?>" alt="Pinterest" title="Pinterest"> </a>
                    <a href="#" target="_blank"> <img data-toggle="tooltip" src="<?php echo Asset::image('socialicons/rss.png');?>" alt="RSS" title="RSS"> </a>
                </div>
            </div>
            <div class="bottom-row">
                <div class="custom-text text-center"> <img alt="" src="<?php echo Asset::image('logo-small.png');?>">
                ...
                <div class="payments_types">
                    <a href="#" target="_blank"> <img data-toggle="tooltip" src="<?php echo Asset::image('payment/payment_paypal.png');?>" alt="paypal" title="PayPal"></a>
                    <a href="#" target="_blank"> <img data-toggle="tooltip" src="<?php echo Asset::image('payment/payment_american.png');?>" alt="american-express" title="American Express"></a>
                    <a href="#" target="_blank"> <img data-toggle="tooltip" src="<?php echo Asset::image('payment/payment_2checkout.png');?>" alt="2checkout" title="2checkout"></a>
                </div>
            </div>
        </div>
    </div>
...
<div id="custom_side_block" class="custom_side_block_right sort-order-2">
    ...
    <table>
        ...
        <tr>
            <td><img alt="" src="<?php echo Asset::image('banner/cms-block.jpg');?>"></td>
        </tr>
        <tr>
...
<script type="text/javascript" src="<?php echo Asset::js('jquery.dcjqaccordion.min.js');?>"></script>
<script type="text/javascript" src="<?php echo Asset::js('owl.carousel.min.js');?>"></script>
