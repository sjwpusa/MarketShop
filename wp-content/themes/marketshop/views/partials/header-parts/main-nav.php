		...
		<div class="collapse navbar-collapse navbar-ex1-collapse">
			<ul class="nav navbar-nav">
				...
				<li class="menu_brands dropdown"><a href="#">برند ها</a>
					<div class="dropdown-menu">
						<div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"><a href="#"><img src="<?php echo Asset::image('product/apple_logo-60x60.jpg');?>" title="اپل" alt="اپل" /></a><a href="#">اپل</a></div>
						<div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"><a href="#"><img src="<?php echo Asset::image('product/canon_logo-60x60.jpg');?>" title="کنون" alt="کنون" /></a><a href="#">کنون</a></div>
						<div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"> <a href="#"><img src="<?php echo Asset::image('product/hp_logo-60x60.jpg');?>" title="اچ پی" alt="اچ پی" /></a><a href="#">اچ پی</a></div>
					</div>
				</li>
